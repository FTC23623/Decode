...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1710.8953524835952; // y position of the parallel encoder (in tick units)
        public double perpXTicks =  -3280.0300468481964; // x position of the perpendicular encoder (in tick units)
    }
