...
public class TurretCR extends Turret_Base {
    ...
    public TurretCR(HydraOpMode opMode, Imu imu, VisionMode target, TurretTrackMode trackingMode, boolean flipEncoder, double targetingOffsetDegrees) {
        super(opMode, imu, target, trackingMode, flipEncoder, targetingOffsetDegrees);
