...
public class TurretKinematics {
    public static double CalcDistanceToTag(VisionResult vision, HydraOpMode opm) {
        ...
        //opm.mTelemetry.addData("Distance - Y offset", targetOffsetAngle_Vertical);
        //opm.mTelemetry.addData("Distance - Angle", angleToGoalDegrees);
