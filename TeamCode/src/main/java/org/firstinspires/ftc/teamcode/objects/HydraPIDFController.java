...
public class HydraPIDFController {
     ...
     */
    public HydraPIDFController(double kp, double ki, double kd, double kf) {
     ...
     */
    public HydraPIDFController(double kp, double ki, double kd, double kf, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
    ...
    public double calculate(double pv) {
        ...
        iTerm = Math.min(maxIntegral, Math.max(minIntegral, iTerm));
